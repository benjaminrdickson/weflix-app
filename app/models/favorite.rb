class Favorite < ApplicationRecord
  ...
  #       poster_path: data["poster_path"], videos: video_key,
  #       release_date: data["first_air_date"], genre: genre,
  #       content_type: "tv", watch_providers: watch_providers }
  #   else
  #     { id: data["id"], title: data["original_title"], overview: data["overview"],
  #       poster_path: data["poster_path"], videos: video_key,
  #       release_date: data["release_date"], genre: genre,
  #       content_type: "movie", watch_providers: watch_providers }
  #   end
  # end
  #
  # private
